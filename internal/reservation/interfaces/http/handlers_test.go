...
func (f *fakeValidadorEquipo) CondicionParaEntregar(ctx context.Context, equipoID string) (application.CondicionDeEquipo, error) {
	estado := f.estados[equipoID]
	if estado == "" {
		estado = "DISPONIBLE"
	}
	return application.CondicionDeEquipo{
