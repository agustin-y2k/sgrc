...
var (
	...
	// ErrExcepcionNoEncontrada: uso interno de infrastructure/ — no tener
	// una excepción cargada para una fecha dada es el caso normal (RF-07.4
	// es opcional), así que Repo.BuscarExcepcionDeFecha lo traduce a
	// (nil, nil) antes de devolverle algo a application/.
